...
### HTML ガイド (v0.9.0 時点)
- **[architecture.html](./architecture.html)** — Architecture &amp; Behavior（37 MCP tools, Lens mode, Phase 2 Desktop Outbox, distribution channels）
- **[user-guide.html](./user-guide.html)** — User Guide（CLI コマンド完全リファレンス・UX Tips・トラブルシューティング）
- **[workflow-guide.html](./workflow-guide.html)** — Workflow Guide（4 builtin templates 詳解 (incl. brainstorming)・YAML schema・カスタム作成方法）
